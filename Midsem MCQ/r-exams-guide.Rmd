...
[`R/exams`](www.r-exams.org) is an R package that generates a reproducible workflow for designing, producing and marking exams.  
...
* At this point I dont know how to generate a pool of questions without an exam. Importing the zip file will also import a test but if you only want a pool of questions to add to blackboard, then you need to delete the test.
