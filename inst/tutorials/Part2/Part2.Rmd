...
> Do not skip exercises - This is the reason you are here
...
In programming, it's *really easy* to make mistakes like typos so that code doesn't work.  
That is no means a reflection on you or your ability to code/learn.  
 ...
 * Duplicates of the same function with multiple errors - keep your scripts tidy!
 ...
 These minor mistakes are the majority of encountered errors. They are not a big deal and are easily corrected.
...
We want you to *understand* the material so that you can use these skills elsewhere. Do you understand *why* we are doing what we are doing in class? For example, in the Type II model, why are we taking the inverse of the variable? 

Treat programming like learning the grammar and syntax of another language.

*** 

### Talk to a rubber duck

In programming, you need a clear idea of what you want to achieve. Try to articulate in words to yourself what you aim to do, what you expect to see if it worked, what you did leading up to this point and what you think is happening to cause the error. This is called the rubber duck method - like you are explaining your problems to a rubber duck.
...
> There's no shame in googling everying - that's what we do too
...
Properly read and digest the teaching material you are given because almost all your assessments will test your reading comprehension and attention to detail. 

 > Learning is about the process and about you, not the end result or your grade
...
###
 ...
 > We **really** advise you to take your time, understand the material and practice before you even look at the assessment. Unless you are 100% confident with data handling and doing multiple regressions in R, do not skip ahead to answer your assessment on the fly. There is nothing here that you don't need to know. You have been warned!
