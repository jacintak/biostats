...
> You need to complete all the exercises to move ahead.
...
Then, check whether your column names and the name of your data *exactly* match the code you've written.  
...
2. Coefficients are the estimated coefficients of the model. Let's start with the first two coefficients. The interpretation for these coefficients is the same as simple linear regression. There's the intercept `(Intercept)` ($\beta_0$) and there's the slope `CW` ($\beta_1$).
