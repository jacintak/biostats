...
<div class="alert alert-danger">
  <strong>Warning!</strong> You must complete all the exercises to move ahead. Do not skip exercises - This is the "practice" of the practical.
</div>
...
> Don't forget to answer the CA questions in a separate link. There are prompts that will tell you when to answer the questions.
...
<div class="alert alert-danger">
  <strong>Warning!</strong> I do not recommend skipping the theory before attempting the CA - the theory section will go through all the steps you need for analysing your data.
</div>
...
<div class="alert alert-danger">
  <strong>Danger!</strong> Do not take the code here for granted. One does not simply copy code from somewhere and blindly expect it to work out of the box.
</div>
...
> There's no shame in googling everying - that's what we do too and part of learning to work independently. aka "Let me google that for you"
...
<div class="alert alert-info">
<strong>Info!</strong>  
R shows the difference between parameter estimates so you need to calculate the correct values. They are the partial regression coefficients that show the change in the response variable with one predictor variable <strong>while holding all other predictor variables constant.</strong> 
</div>
...
<div class="alert alert-danger">
  <strong>Warning!</strong> Statistical significance is not the same thing as biological significance.  

A relationship between two purely randomly generated numbers can be statistically significant but have no biological meaning. Details matter!
</div>
...
<div class="alert alert-danger">
  <strong>Warning!</strong> People's obsession over getting significant P values has driven a rise of unethical statistical practices (called P hacking or P fishing) which we do not want you as young scientists to fall into the habit of.
</div>
...
<div class="alert alert-info">
<strong>Info!</strong> Refer to the previous drop in sessions and practicals to revise these basic steps. Make sure your address is correct and don't forget .csv at the end.
</div>
...
<div class="alert alert-info">
<strong>Info!</strong> `data$column` is the general structure to select a column in R. Make sure that your dataset name and your column names in your code matches your data name and columns.
</div>
...
<div class="alert alert-danger">
  <strong>Warning!</strong> Since we have done some division, it's a good time to check for any undefined values in case we divided by 0. 
</div>
...
<div class="alert alert-success">
It's time to answer the CA!. Remember to save and submit your answers. That's the end of the assessment but not the end of the practical. Keep going.
</div>
...
<div class="alert alert-info">
<strong>Info!</strong> Red-Green colour blindness is the most common form of colour blindness. A simple guideline is to avoid using red and green together where ever possible. Blue and orange are better contrasting colours (that's why they are common colour schemes for movie posters).
</div>
...
**Write down the parameterised equation of the interactive regression lines for blue and orange crabs before progressing.**
...
<div class="alert alert-info">
<strong>Info!</strong> Aiming to minimise the number of parameters used in a linear model is the statistical concept of **model parsimony**. 
</div>  
...
<div class="alert alert-success">
We have followed a **workflow** of data analysis that you can apply to any data handling.
</div>  
