...
<h3 class="panel-title">Discussion</h3>
  ...
  <div class="panel-body">
How would you describe the below Type II relationship in words in a results section of a lab report? </div>
</div>
...
This data will need to be **cleaned** before it can be analysed. See next section. So putting in the effort and attention to detail now will save future you a lot of avoidable stress! </div>
</div>
