...
H0: There is no difference in the number of prey eaten with prey density between predator efficiency  
H1: There is a difference in the number of prey eaten with prey density between predator efficiency 
...
quiz(
  question(
    "Which of these variables are we changing to compare different predator efficiency?",
...
quiz(question_text(
  ...
  question_text(
    ...
    answer("2", correct = TRUE, message = "Prey density and predator efficiency"),
    allow_retry = TRUE
  )
)
```
...
| predator_efficiency            	| character        	| `naive` for no experience or `experienced` for a experienced predator |
...
```{r radio1, echo = FALSE}
question_radio(
  "What should be entered in the cell under the column predator_efficiency when using a predator without experience",
