...
There is a trade-off between precision, generality and realism of models -- there is no, one "perfect" model.
...
```{r assumptions}
quiz(caption = "First, a quick question on variables",
question(
...
Total foraging time is another constant.
