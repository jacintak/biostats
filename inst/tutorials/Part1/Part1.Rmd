...
**Quizzes**  
**Quizzes here are not part of the CA.** The questions are meant to check you understand the material and your answers are not visible to anyone else. If you can answer the quizzes correctly, then the CA will be no trouble to you.
...
Well done!  
Your answers are saved if you open the tutorial again. You can reset *all* answers by clicking **Start Over** at the end of the menu. You can run these tutorials any time you like if you want to practice again. 
...
<h3 class="panel-title">Discussion</h3>
  ...
  <div class="panel-body">
Blue boxes are discussion questions that you should think about or write down an answer to. </div>
</div>

Click **Next Topic** to move to the next section. You can navigate between topics using the buttons or the menu. You can access the menu if minimised by clicking the the title "Statistical Modelling Part 1".
...
<h3 class="panel-title">Warning!</h3>
  ...
  <div class="panel-body">
You need to complete all the exercises to move ahead. All the exercises are learning outcomes of this module, are also covered in the lectures, and are relevant to the CA! </div>
</div>
...
The practicals and lectures will feed off each other and these will also build upon the previous lectures and practicals. All concepts in this practical are assessable and relevant to the lectures. I expect you to be up to date with the module material. As this practical comes first, we will start with an introduction to statistical modelling that we will continue in the lectures.
...
Statistical modelling is an umbrella term in statistics that refers to many things and broadly speaking is a philosophical way of thinking about data.
...
<h3 class="panel-title">Remember!</h3>
  ...
  <div class="panel-body">
Science isn't about "proving" a hypothesis or being "right" -- it's when we "fail" or are wrong that progress happens. </div>
</div>
...
question_radio("Statistical models aim to accurately and precisely describe reality as it is",
  answer("False", correct = TRUE, message = "How do you know that what you percieve is true? Or, how you you know you are not living in a simulation?"),
...
There are multiple types of functional responses (labelled with Roman numerals: I --- IV). Each of these models represents a *different hypothesis* about functional responses and mathematically describes a *different relationship* between our two variables (e.g. the killer T cell and the pathogen, or a predator and its prey). You can read about functional responses by running `vignette("functional_responses")`.
...
```{r models-quiz}
quiz(caption = "Test what you've learnt about statistical models so far:",
  question(
...
<h3 class="panel-title">Discussion</h3>
  ...
  <div class="panel-body">
Variables or parameters? Which is which in our model? What information do we know and what do we need to find out? And how would you find it out? </div>
</div>
...
<h3 class="panel-title">For the rest of the practical we will look at the question:</h3>
  ...
  <div class="panel-body">
What happens to the number of prey a predator can eat when the number of prey in an area (the density) increases? </div>
</div>
...
If you are not sure how to formulate a hypothesis, look back at previous material. </div>
</div>
...
<h3 class="panel-title">Choose wisely!</h3>
  ...
  <div class="panel-body">
The wording of your hypothesis will dictate the best experimental design and statistical analysis to test your hypothesis! Think carefully about the details. </div>
</div>

The alternative hypothesis describes the direction but not the strength of the relationship. If you are less certain about your predicted outcomes you could be less specific if you wanted to (e.g. "There is a linear relationship between prey density and number of prey eaten" means the hypothesised relationship could be positive *or* negative). 
...
<h3 class="panel-title">Discussion</h3>
  ...
  <div class="panel-body">
Why should we not touch the counters after we have placed them on the paper? </div>
</div>
...
We can rephrase our two hypotheses to include the effect of foraging strategy:
...
<h3 class="panel-title">Discussion</h3>
  ...
  <div class="panel-body">
Formulate a more specific hypothesis we can use as an alternative hypothesis. </div>
</div>
...
<h3 class="panel-title">Remember!</h3>
  ...
  <div class="panel-body">
The alternative hypothesis is the outcome we would expect if there was an effect of the predictor on the response variable. The null hypothesis is what we expect when there is no effect (hence, null). Most of the time we want there to be an effect (what we hope is true about a biological system). </div>
</div>
...
<h3 class="panel-title">Discussion</h3>
  ...
  <div class="panel-body">
  Which of the statistical tests you've already learnt would you use to analyse the data if foraging strategy was the only predictor variable? </div>
</div>
...
In this case, the wide format would be inappropriate for analysis because each row is not an observation, but three independent observations, and each column is not an independent variable but treatment levels of one variable. We would not be able to do stats on the wide format (e.g. a t-test) because the relevant data is split over multiple columns, rather than one column. We would need to use the long format (and a t-test is inappropriate for this dataset).
...
<h3 class="panel-title">Discussion</h3>
  ...
  <div class="panel-body">
Why is a t-test inappropriate for this dataset and which test would be?  
You should be able to answer this because you've covered it in lectures!</div>
</div>

Sometimes we need to convert the data structure from wide to long or vice versa. We won't be needing to do this in this module because we are taking care with designing our data sheet to make it easier to analyse our data with minimal post-collection data manipulation.
...
<h3 class="panel-title">Info!</h3>
  ...
  <div class="panel-body">
These guidelines are how R reads data from a spreadsheet. Thus, following these best practices will prevent errors when importing data into R. </div>
</div>
...
<h3 class="panel-title">Warning!</h3>
  ...
  Look at the how the `PlantGrowth` dataset above is laid out as an example of how your spreadsheet should look like.
  
  Even having a space within a field will be read as a unique word. E.g. `"cat"`, `"cat "` and `" cat"` would be read as three distinct inputs. 
 </div>
</div>
...
Checking and correcting data is called **cleaning**. We take raw data and clean it up. Sometimes data cannot be fixed (e.g. errors of unknown origin), then the conservative approach is to exclude the observation which is a shame if lots of time and effort (or money) went in to collecting it.

In the real world, data is almost never clean and cleaning often takes longer than the actual analysis! It is a real pain! >:(

***

### Uploading your dataset to Blackboard

Save your data sheet **as a csv file** (click "Save As" and select csv file type). No other file types are accepted. Your file name should be your student number and practical session separated by `_`. e.g. `12345_AM.csv` for the morning session.
