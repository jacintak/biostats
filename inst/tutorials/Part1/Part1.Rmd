...
<h3 class="panel-title">Discussion</h3>
  ...
  <div class="panel-body">
These are discussion questions that you should think about or write down an answer to. </div>
</div>
...
<h3 class="panel-title">Warning!</h3>
  ...
  <div class="panel-body">
You need to complete all the exercises to move ahead. </div>
</div>
...
<h3 class="panel-title">Choose wisely!</h3>
  ...
  <div class="panel-body">
The wording of your hypothesis will dictate the best experimental design and statistical analysis to test your hypothesis! </div>
</div>
...
<h3 class="panel-title">Remember!</h3>
  ...
  <div class="panel-body">
As scientists we never try to "prove" hypotheses. We aim to gather evidence and see whether the evidence supports our hypothesis. </div>
</div>
