...
* Middle: Set up the counters and timer
    * prey_density is the number of prey our predator has captured, $H_a$
    * digesting is the foraging state of the predator, you can ignore this but it is an implementation of our assumptions that handling and searching for prey are mutually exclusive activities
    * total_time is the duration of the predator-prey interaction, $T_{total}$. This should be 60 seconds (1 minute).
