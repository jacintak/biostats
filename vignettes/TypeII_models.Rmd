...
$$\frac{1}{H_a} = \frac{1 + \times T_h\times a \times H}{T_{total} \times a \times H}$$
$$\Rightarrow H_a = \frac{a \times H \times T_{total}}{1 + a \times H \times T_h}$$

## Linearising our functional response

The Type II equation can be written in a linear form representing $y = \beta x + \alpha$.  
